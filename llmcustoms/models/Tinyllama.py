...
class TinyLlama(BaseModel):
    def __init__(self):
        super().__init__()
        self.model_key = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
        self.display_name = "TinyLlama-1.1B-Chat-v1.0"
        self.hf_repo = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
        self.model_size_gb = 4.4
        self.vram_requirements = {
            "min": 1.5,
            "recommended": 2,
            "optimal": 3
        }
        self.model_params = 1.1
